...
set IPName      "geo_dist"
set Version     "1.0"
set DisplayName "Geo_dist"
set Revision    "2106211654"
...
set sdx_kernel_name "geo_dist"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/student/aces_project_rc/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {geo_dist_mul_60nscud
...
set Interfaces {
    s_axi_geo_dist_if {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_geo_dist_if"
        param_prefix "C_S_AXI_GEO_DIST_IF"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 lat_a_V W 0x0 "Data signal of lat_a_V" {{0 20 lat_a_V W 0 "Bit 19 to 0 Data signal of lat_a_V"} {20 12 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 lon_a_V W 0x0 "Data signal of lon_a_V" {{0 20 lon_a_V W 0 "Bit 19 to 0 Data signal of lon_a_V"} {20 12 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 lat_b_V W 0x0 "Data signal of lat_b_V" {{0 20 lat_b_V W 0 "Bit 19 to 0 Data signal of lat_b_V"} {20 12 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 lon_b_V W 0x0 "Data signal of lon_b_V" {{0 20 lon_b_V W 0 "Bit 19 to 0 Data signal of lon_b_V"} {20 12 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 result_V R 0x0 "Data signal of result_V" {{0 20 result_V R 0 "Bit 19 to 0 Data signal of result_V"} {20 12 RESERVED R 0 "Reserved.  0s on read."}}} {0x34 result_V_ctrl R 0x0 "Control signal of result_V" {{0 1 result_V_ap_vld R 0 "Control signal result_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
