...
\DoxyCodeLine{\textcolor{keyword}{using namespace }\mbox{\hyperlink{namespaceRoutingKit}{RoutingKit}};}
...
\DoxyCodeLine{    \textcolor{keyword}{auto} ch = \mbox{\hyperlink{classRoutingKit_1_1ContractionHierarchy_aacccc44dcef8bf7465f41cec43cade80}{ContractionHierarchy::build}}(}
...
\DoxyCodeLine{    \mbox{\hyperlink{classRoutingKit_1_1GeoPositionToNode}{GeoPositionToNode}} map\_geo\_position(graph.latitude, graph.longitude);}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{comment}{// Besides the CH itself we need a query object. }}
\DoxyCodeLine{    \mbox{\hyperlink{classRoutingKit_1_1ContractionHierarchyQuery}{ContractionHierarchyQuery}} ch\_query(ch);}
\DoxyCodeLine{}
...
You can get O\+SM P\+BF exports from various sources. A popular one is \href{https://download.geofabrik.de/}{\texttt{ Geofabrik}}. Another one is \href{https://mapzen.com/data/metro-extracts/}{\texttt{ Mapzen}}.\hypertarget{index_autotoc_md1}{}\doxysection{Documentation}\label{index_autotoc_md1}
The functions of \mbox{\hyperlink{namespaceRoutingKit}{Routing\+Kit}} are made available using different headers. This allows for a fine-\/grained control over what is made available and what not. The exact headers are available from the documentation. For cases where this fine-\/grained control is not necessary, \mbox{\hyperlink{namespaceRoutingKit}{Routing\+Kit}} provides the {\ttfamily $<$\mbox{\hyperlink{all_8h_source}{routingkit/all.\+h}}$>$} header, which includes everything. All functionality is in the {\ttfamily \mbox{\hyperlink{namespaceRoutingKit}{Routing\+Kit}}} namespace.
...
\end{DoxyItemize}\hypertarget{index_autotoc_md2}{}\doxysection{Publications}\label{index_autotoc_md2}
